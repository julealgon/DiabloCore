...
struct Object {
	...
	*/
	...
	bool IsDoor() const
	{
		return _otype == AnyOf(_object_id::OBJ_L1LDOOR, _object_id::OBJ_L1RDOOR, _object_id::OBJ_L2LDOOR, _object_id::OBJ_L2RDOOR, _object_id::OBJ_L3LDOOR, _object_id::OBJ_L3RDOOR);
	}
};
